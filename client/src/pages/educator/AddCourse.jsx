...
//   const [chapters, setChapters] = useState([
//     // { id: uniqid(), chapterTitle: "Introduction", chapterContent: [], collapsed: false }
//   ]);
...
//             collapsed: false,
//             chapterOrder:
//               prev.length > 0 ? prev[prev.length - 1].chapterOrder + 1 : 1,
//           },
//         ]);
//         break;
...
//       default:
//         console.warn("Invalid action in handleChapter");
//     }
//   };
...
//   // Handle image preview and cleanup memory leaks
//   useEffect(() => {
//     if (!image) {
//       setPreview("");
//       return;
...
//               />
//               {preview && (
//                 <img className="max-h-10" src={preview} alt="Preview" />
//               )}
//             </label>
//           </div>
//         </div>
...
//                   }`}
//                   disabled={!lectureDetails.lectureTitle.trim()}
//                 >
//                   Add
//                 </button>
